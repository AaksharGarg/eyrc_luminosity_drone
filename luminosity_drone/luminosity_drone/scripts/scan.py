...
class swift:
    ...
    def __init__(self):
        ...
        self.point_num=-1
        self.setpoint = [[0,0,20],[5,5,20]]  # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
