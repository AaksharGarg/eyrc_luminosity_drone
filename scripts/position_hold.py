...
class swift():
	...
	def __init__(self):
		...
		self.setpoint = [10,10,10] # whycon marker at the position of the dummy given in the scene. Make the whycon marker associated with position_to_hold dummy renderable and make changes accordingly
	...
	def pid(self):
		...
		self.cmd.rcThrottle = 1580 + P + I + D
