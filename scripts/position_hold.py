...
class swift():
	...
	def __init__(self):
		...
		# self.sample_time = 0.33 # in seconds
	...
	#	8. Add error_sum
		...
		self.alt_error = -(self.setpoint[2]-self.drone_position[2]) #z axis

		self.rcThrottle = int(1600 + self.alt_error*self.Kp[2] + ((self.alt_error-self.prev_alt_error)*self.Kd[2]) + self.sum_alt_error*self.Ki[2])
